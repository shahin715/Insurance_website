...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${navHeight}`}>
        ...
        <div className={`h-full transition-all duration-300
          ...
          <div className="max-w-7xl mx-auto px-6 h-full">
            <div className="flex items-center justify-between h-full">
              ...
              {/* Logo */}
              <div className={`flex items-center text-white transition-all duration-300
              ...
              {/* Desktop Menu  */}
              <nav className={`hidden md:flex items-center text-white font-medium transition-all duration-300
              ...
              `}>
                ...
                <div className="relative group">
                  ...
                  <div className="absolute top-full left-0 mt-3 w-56 bg-white text-gray-800 rounded-lg shadow-xl
                    ...
                    <Link href="/ceo-message" className="block px-4 py-2 hover:bg-gray-100">
                      CEO Message
                    </Link>
                    ...
                    <Link href="/public-disclosure" className="block px-4 py-2 hover:bg-gray-100">
                      Public Disclosure
                    </Link>
        ...
        {/*  Mobile Menu  */}
        <div className={`${menuOpen ? "max-h-[500px]" : "max-h-0"} md:hidden overflow-hidden transition-all duration-300`}>
          <div className="px-6 pb-6 pt-4 space-y-3 text-white bg-[#7a1e6a]">
            ...
            <div className="ml-4 space-y-2 text-sm opacity-90">
              ...
              <Link href="/public-disclosure">Public Disclosure</Link>
