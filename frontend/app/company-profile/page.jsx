...
export default function CompanyProfilePage() {
  ...
  useEffect(() => {
    (async () => {
      ...
      const section = page.sections.find(s => s.type === "company_profile");
      if (section) setData(section.data);
    })();
  }, []);
...
>
  ...
  View on Map
      ...
      <div className="max-w-7xl mx-auto px-6 mt-14 grid md:grid-cols-2 gap-6">
        ...
        <SimpleBox title="Auditors" icon={Building2}>{data.auditors}</SimpleBox>
...
/*  COMPONENTS — ONLY TEXT COLOR CHANGED  */
